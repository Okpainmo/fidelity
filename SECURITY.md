...
Fidelity is currently in pre-release (0.x) development.
...
| Unreleased / main branch | :x:                |

> ⚠️ Pre-1.0 versions are considered unstable and may introduce breaking changes.
